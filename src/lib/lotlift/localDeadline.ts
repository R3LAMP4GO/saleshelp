...
/** Shared deadline for hosted contextual selection in production and training. */
export const LOTLIFT_CONTEXTUAL_MODEL_DEADLINE_MS = 3_000;
export const LOTLIFT_REMOTE_MODEL_DEADLINE_DEFAULT_MS = LOTLIFT_CONTEXTUAL_MODEL_DEADLINE_MS;
...
export function resolveLotLiftTurnDeadline(_settings: Settings | undefined, override: number | undefined): number {
  if (override !== undefined) return clampLotLiftLocalModelDeadline(override);
  return LOTLIFT_REMOTE_MODEL_DEADLINE_DEFAULT_MS;
}
