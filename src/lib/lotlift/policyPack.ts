...
export const LOTLIFT_TACTIC_RULES: Record<LotLiftPolicyTacticId, readonly LotLiftPlaybookRuleId[]> = {
  ...
  "concern-isolation": ["qualification:pain", "objection:no-budget", "objection:roi"],
...
export const LOTLIFT_APPROVED_MOVE_IDS = [
  ...
  "first-refusal", "answer-and-advance", "ai-skepticism", "staff-adoption", "guided-objection-discovery", "contextual-response", "price-isolation", "price-value-workflow-check", "price-value-uncertainty", "price-pain-value", "price-stakeholder-criteria", "price-next-criterion", "crm-coverage", "impact-coverage", "identify-owner", "right-person-process", "lead-source",
  "gap-after-hours", "gap-visibility", "gap-impact", "v7-product-answer", "confirm-authority", "workflow-check", "timing-follow-up", "information-topic", "decision-criteria", "existing-workflow-coverage", "fit-source-volume", "competitor-criteria", "security-authorization", "limitation-route", "terra-composition",
] as const;
...
export const LOTLIFT_MOVE_TACTICS: Record<LotLiftApprovedMoveId, LotLiftPolicyTacticId> = {
  ...
  "ai-skepticism": "concern-isolation", "staff-adoption": "concern-isolation", "guided-objection-discovery": "concern-isolation", "contextual-response": "contextual-answer", "price-isolation": "concern-isolation", "price-value-workflow-check": "scoped-next-step", "price-value-uncertainty": "decision-criteria", "price-pain-value": "concern-isolation", "price-stakeholder-criteria": "decision-criteria", "price-next-criterion": "concern-isolation", "crm-coverage": "solution-verification", "impact-coverage": "impact-clarification", "identify-owner": "permission-and-route", "right-person-process": "workflow-discovery", "lead-source": "workflow-discovery",
  "gap-after-hours": "workflow-discovery", "gap-visibility": "workflow-discovery", "gap-impact": "impact-clarification", "terra-composition": "contextual-answer", "v7-product-answer": "contextual-answer", "confirm-authority": "solution-verification", "workflow-check": "scoped-next-step", "timing-follow-up": "consented-follow-up", "information-topic": "consented-follow-up", "decision-criteria": "decision-criteria", "existing-workflow-coverage": "solution-verification", "fit-source-volume": "workflow-discovery", "competitor-criteria": "solution-verification", "security-authorization": "truthful-limitation", "limitation-route": "truthful-limitation",
};
