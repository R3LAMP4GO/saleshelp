...
export const LOTLIFT_APPROVED_MOVE_IDS = [
  ...
  "gap-after-hours", "gap-visibility", "gap-impact", "v7-product-answer", "confirm-authority", "workflow-check", "timing-follow-up", "information-topic", "decision-criteria", "existing-workflow-coverage", "fit-source-volume", "competitor-criteria", "security-authorization", "limitation-route",
] as const;
...
export const LOTLIFT_MOVE_TACTICS: Record<LotLiftApprovedMoveId, LotLiftPolicyTacticId> = {
  ...
  "gap-after-hours": "workflow-discovery", "gap-visibility": "workflow-discovery", "gap-impact": "impact-clarification", "v7-product-answer": "contextual-answer", "confirm-authority": "solution-verification", "workflow-check": "scoped-next-step", "timing-follow-up": "consented-follow-up", "information-topic": "consented-follow-up", "decision-criteria": "decision-criteria", "existing-workflow-coverage": "solution-verification", "fit-source-volume": "workflow-discovery", "competitor-criteria": "solution-verification", "security-authorization": "truthful-limitation", "limitation-route": "truthful-limitation",
};
